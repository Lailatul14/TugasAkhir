...
<div class="card-header">
 <strong class="card-title">Tambah Pembayaran</strong>
</div>
<div class="card-body card-block">
<form action="PembayaranStore" method="POST" enctype="multipart/form-data" class="form-horizontal">
  
	{{ csrf_field() }}

<div class="row form-group">
  <div class="col col-md-3">
    <label for="text-input" class=" form-control-label">Tipe Pembayaran</label></div>
...
<div class="row form-group">
<div class="col col-md-3"><label for="text-input" class=" form-control-label">Tipe Pembayaran</label></div>
