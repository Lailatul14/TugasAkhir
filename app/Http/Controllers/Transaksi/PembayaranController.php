...
class PembayaranController extends Controller
{
    ...
    public function index()
    {
       ...
       return view('Pembayaran/index_pembayaran', ['penyewaan' => $penyewaan, 'pembayaran' => $pembayaran ]);
          }
          }
    ...
    {
        $penyewaan = DB::table('penyewaan')->pluck("TIPE_PEMBAYARAN","ID_SEWA");
        $pembayaran = DB::table('pembayaran')->get();
        return view('Pembayaran/create_pembayaran',compact('penyewaan', 'pembayaran'))->with('success', 'Data Berhasil Ditambahkan');
    }
